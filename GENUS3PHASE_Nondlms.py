...
#     a0, a1, a2, a3 = a
#     X = nibble_swap(((a1+a2+a3)^a2 + a0) & 0xFF)
#     Y = nibble_swap(((a0+a2+a3)^a3 + a1) & 0xFF)
#     return X, Y
...
class MeterGUI:
    ...
    def build_ui(self):
        ...
        commands = [
            ("Meter ID",0x01),("Utility",0x02),("RTC",0x03),
            ("Voltage/Current",0x04),("PF",0x10),
            ("Power",0x11),("MD",0x12),
            ("Energy Z",0x20),("Energy Total",0x21),
            ("Reactive Energy",0x24)
        ]
